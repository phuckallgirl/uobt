        ...
        return (
            <Button style={{marginTop: this.props.first ? 10 : 0}} onPress={this.props.onPress}>
                <View style={styles.button}>
                    <Text style={{color: this.props.color || "#FF0000"}}>{this.props.name}</Text>
                </View>
            </Button>
        )
    }
            ...
            <View style={styles.listItem}>
                ...
                <View style={[styles.listInfo, {borderTopWidth: !first ? 1 : 0}]}>
                    ...
                    <View style={styles.listInfoRight}>
                        {subName ? (
                            <Text style={{color: "#AAAAAA", fontSize: 12}}>{subName}</Text>) : null}
                        ...
                        {disable ? null : (
                            <Font.Ionicons style={{marginLeft: 10}} name="ios-chevron-forward" size={px2dp(18)} color="#BBBBBB"/>)}
                    </View>
                </View>
            </View>
        )
