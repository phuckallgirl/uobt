...
export default  class  ModalDialog extends Component {
    ...
    show(options) {
         if(options) {
             ...
             let clickScreenToHide=options.clickScreenToHide==undefined?true:options.clickScreenToHide;
             let animationType=options.animationType==undefined?'fade':options.animationType;
             let headTitle=options.headTitle==undefined?'提示':options.headTitle;
             let hiddenTitle=options.hiddenTitle==undefined?false:options.hiddenTitle;
             let headStyle=options.headStyle==undefined?'':options.headStyle;
             let messText=options.messText==undefined?'':options.messText;
             let innersWidth=options.innersWidth==undefined?defaultWidth:options.innersWidth;
             let innersHeight=options.innersHeight==undefined?defaultHeight:options.innersHeight;
