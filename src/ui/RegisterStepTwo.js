...
export default class RegisterStepTwo extends BaseApp {
	...
	getPresenter(): BasePresenter {
		mPresenter = RegisterPresenter.getInstance(this);
		return mPresenter;
	}
    ...
    pressRegister = () => {
        ...
        var param = {
            uname: this.registerInfo.username,
            passcode: SignUtils.md5(this.registerInfo.password),
            cellphone: this.state.phone,
            nickname: this.registerInfo.username,
            invite: this.registerInfo.recommend,
