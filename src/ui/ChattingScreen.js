...
import Global from "./chat/utils/Global";
import Utils from "./chat/utils/Utils";
import TimeUtils from "./chat/utils/TimeUtil";
import ChatBottomBar from "./chat/ChatBottomBar";
import MoreView from "./chat/MoreView";
import LoadingView from "./chat/LoadingView";
import CountEmitter from "./chat/event/CountEmitter";
//import Emoticons from "react-native-emoticons";
import UserInfoUtil from "./chat/utils/UserInfoUtil";
//import ImageAdapter from "./chat/ImageAdapter";
...
export default class ChattingScreen extends Component {
  constructor(props) {
    ...
    // 聊天人username或groupId
    this.chatContactId = '1001';
    // 聊天人昵称或群名称
    this.chatUsernick = '乌鸦';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <TabHeader bgcolor="#1E82D2" text="客服中心" back />
  ...
  renderReceivedTextMsg(item) {
    let contactAvatar = require("../res/img/avatar.png");
    if (this.chatType === "group") {
      // 群聊的头像为某个人的头像
  ...
  renderSendTextMsg(item) {
    let avatar = require("../res/img/avatar.png");
